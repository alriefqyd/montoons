...
export default function TopBar() {
    ...
    const dropDownTarget = useRef(); // useRef is function that can get element user clicked by ref attribute


    const triggerDropdown = () => { // function that can check dropdown is open or closed and change the state vaslue
        if(dropDownOpen){
